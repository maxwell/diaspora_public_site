...
<hr>
<h4>Finally, we wanted to touch on your point about being a pragmatist.</h4>

p. We think we are pretty pragmatic guys too(maybe not quite "tieguys":http://tieguy.org), but there is something we just don't quite understand.
